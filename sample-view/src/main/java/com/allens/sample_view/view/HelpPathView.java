...
public class HelpPathView extends View {
    ...
    public HelpPathView(Context context) {
        this(context,null);
    }

    public HelpPathView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public HelpPathView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public static void drawGrid(Canvas canvas, Point winSize, Paint paint) {
        ...
        canvas.drawPath(HelpPathView.gridPath(50, winSize), paint);
    }
    ...
    public static void drawCoo(Canvas canvas, Point coo, Point winSize, Paint paint) {
        ...
        //绘制直线
        canvas.drawPath(HelpPathView.cooPath(coo, winSize), paint);
        //左箭头
